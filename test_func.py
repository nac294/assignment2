...
def test_output_less_than():
    assert handle_output(0) == "Invalid BMI"  # ON
    assert handle_output(0.1) == "Underweight"  # OFF
    assert handle_output(9) == "Underweight"  # INTERIOR
...
def test_output_greater_than():
    assert handle_output(29.9) == "Overweight"  # OFF
    assert handle_output(30) == "Obese"  # ON
    assert handle_output(31) == "Obese"  # INTERIOR
